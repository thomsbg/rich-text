...
var lib = {
  attributes: {
    clone: function (attributes, keepNull) {
      ...
      return Object.keys(attributes).reduce(function (memo, key) {
        if (attributes[key] !== undefined && (attributes[key] !== null || keepNull)) {
          if (is.object(attributes[key])) {
            memo[key] = lib.attributes.clone(attributes[key], keepNull);
          } else {
    ...
    compose: function (a, b, keepNull) {
      ...
      for (var key in a) {
        ...
        } else if (is.object(a[key]) && is.object(b[key])) {
          var composed = this.compose(a[key], b[key], keepNull);
          if (composed === undefined) {
            delete attributes[key];
          } else {
            attributes[key] = composed;
          }
        }
      }
    ...
    diff: function(a, b) {
      ...
      var attributes = Object.keys(a).concat(Object.keys(b)).reduce(function (attributes, key) {
        if (!is.equal(a[key], b[key])) {
          if (is.object(a[key]) && is.object(b[key])) {
            attributes[key] = lib.attributes.diff(a[key], b[key]);
          } else {
    ...
    transform: function (a, b, priority) {
      ...
      var attributes = Object.keys(b).reduce(function (attributes, key) {
        if (a[key] === undefined) {
          ...
          attributes[key] = lib.attributes.transform(a[key], b[key], priority);
        }
        return attributes;
      }, {});
      return Object.keys(attributes).length > 0 ? attributes : undefined;
  ...
  clone: function (op) {
    var newOp = Object.keys(op).reduce(function(newOp, key) {
      newOp[key] = op[key];
      return newOp;
    }, {});
